...
# C Compiler Flags
CFLAGS=-m32 -Wl,--add-stdcall-alias -I/C/Program\ Files/Java/jdk1.7.0_51/include -I/C/Program\ Files/Java/jdk1.7.0_51/include/win32
...
${OBJECTDIR}/JavaCom.o: JavaCom.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I.  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JavaCom.o JavaCom.c
...
${OBJECTDIR}/JavaCom_nomain.o: ${OBJECTDIR}/JavaCom.o JavaCom.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -I.  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JavaCom_nomain.o JavaCom.c;\
	else  \
